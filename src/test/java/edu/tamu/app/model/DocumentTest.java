...
public class DocumentTest extends AbstractClass {
    ...
    public void testCreateDocument() {
        testDocument = documentRepo.create(testProject, mockDocument.getName(), mockDocument.getTxtUri(), mockDocument.getTxtPath(), mockDocument.getPdfUri(), mockDocument.getPdfPath(), mockDocument.getStatus());
    ...
    public void testFindDocument() {
        assertEquals("Test Document already exists.", null, documentRepo.findByName("testFile"));
        ...
        testDocument = documentRepo.findByName(mockDocument.getName());
