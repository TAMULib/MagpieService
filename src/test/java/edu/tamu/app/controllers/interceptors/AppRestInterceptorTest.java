...
import edu.tamu.app.controllers.AbstractControllerClass;
import edu.tamu.framework.model.Credentials;

public class AppRestInterceptorTest extends AbstractControllerClass {

	@Test
	public void testAnonymousCredentials() {
		Credentials testCredentials = appRestInterceptor.getAnonymousCredentials();
	...
	public void testConfirmCreateUser() {
		Credentials testCredentials = appRestInterceptor.confirmCreateUser(credentials);
