...
import edu.tamu.app.controller.AdminController;
import edu.tamu.app.controller.ControlledVocabularyController;
import edu.tamu.app.controller.DocumentController;
import edu.tamu.app.controller.MetadataController;
import edu.tamu.app.controller.ProjectController;
import edu.tamu.app.controller.SuggestionController;
import edu.tamu.app.controller.UserController;
...
public abstract class AbstractControllerClass extends MockData {
    ...
    public void setUp() {
    	...
    	when(userRepo.create(any (Long.class), any (String.class), any (String.class), any (String.class))).then( new Answer<AppUser>() {
			@Override
			public AppUser answer(InvocationOnMock invocation) throws Throwable {
				return createUser( (Long) invocation.getArguments()[0],  (String) invocation.getArguments()[1], (String) invocation.getArguments()[1] , (String) invocation.getArguments()[2]);
			}
    	});
