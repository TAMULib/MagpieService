...
public class MockData {
	...
	protected static Document document1 = new Document(TEST_PROJECT1, "Document2 Name ", "Document2 txtUri ", "Document2 pdfUri", "Document2 txtPath", "Document2 pdfPath", "Document2 documentPath", "Published");
	protected static Document document2 = new Document(TEST_PROJECT1, "Document2 Name ", "Document2 txtUri ", "Document2 pdfUri", "Document2 txtPath", "Document2 pdfPath", "Document2 documentPath", "Accepted");
	protected static Document document3 = new Document(TEST_PROJECT1, "Document2 Name ", "Document2 txtUri ", "Document2 pdfUri", "Document2 txtPath", "Document2 pdfPath", "Document2 documentPath", "Pending");
	protected static Document document4 = new Document(TEST_PROJECT1, "testDocument", "txtUri", "pdfUri", "txtPath", "pdfPath", "documentPath", "Unassigned");
	
	protected static List<Document> mockDocumentSet = new ArrayList<Document>(Arrays.asList(new Document[] {document1 , document2 , document3}));//new ArrayList<Document>();
	...
	static {
		...
		TEST_PROJECT1.setDocuments(mockDocumentSet);
		// TEST_PROJECT1.addDocument(document1);
		// TEST_PROJECT1.addDocument(document2);
